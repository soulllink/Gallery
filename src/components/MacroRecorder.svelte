<script lang="ts">
    import { isRecording, currentRecordingSlot, recordedActions, macroSlots } from '../stores';
    ...
    async function playMacro(slotIndex: number) {
        ...
        window.dispatchEvent(new CustomEvent('playMacro', { detail: slot.actions }));
    }
        ...
        <div class="macro-panel glass-panel">
            <div class="macro-header">
                ...
                <div class="macro-actions">
                    <button class="action-btn" on:click={saveMacros} title="Save Macros">💾</button>
                    <button class="action-btn" on:click={loadMacros} title="Load Macros">📂</button>
                </div>
            </div>
