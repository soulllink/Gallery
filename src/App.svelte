<script lang="ts">
  ...
  import { handleDrop } from './lib/fileSystem';
...
<style>
  ...
  /* The following styles are kept from the original document,
     as they were not explicitly removed by the instruction's diff. */
  .drop-overlay {
    position: absolute;
    top: 0;
    left: 0;
